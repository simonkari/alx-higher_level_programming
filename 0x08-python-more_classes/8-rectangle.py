...
class Rectangle:
    """A Rectangle class designed to handle the printing or computation
    of dimensions for a rectangleA Rectangle class designed to handle
    the printing or computation of dimensions for a rectangle
    ...
    and perimeter of the rectangle. Additionally, it defines
    functionality for the __str__, __repr__, and __del__ methods."

    Attributes:
        number_of_instances (int): represnting counter
        incrementing for everyinstantiation, and decrementing
        for every instance deletion.print_symbol (str):
        representing single character to be used in assembling
    ...
    def width(self, value):
        """Args:
            value (int): representation of the horizontal
            dimension of rectangle

        Attributes:
            __width (int): representation of the horizontal
            dimension of rectangle
    ...
    def height(self, value):
        """Args:
            value (int): represent vertical dimension of the rectangle.
    ...
    def area(self):
        """Returns area of ectangle of given `width` and `height`.
...
.
    ...
    def _draw_rectangle(self):
        ...
        Attributes:
            __width (int): represent horizontal dimension of the rectangle.
            __height (int): represent vertical dimension of the rectangle.
            str (str): represent the string to constructed for return.

        Returns:
            str (str): string suitable for printing the
    ...
    def bigger_or_equal(rect_1, rect_2):
        """Compares area of instances and returns the larger.

        Args:
            rect_1 (Rectangle object): represent first instance to be compared
            rect_2 (Rectangle object): represent second instance to be compared
